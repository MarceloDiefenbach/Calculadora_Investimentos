                        ...
                        HStack{
                            ZStack{
                                RoundedRectangle(cornerRadius: UIScreen.main.bounds.height*0.015)
                                    ...
                                    Text("\(formatarCotacao(valor: valor, tipo: false))").foregroundColor(Color.white)
                            ...
                            ZStack{
                                RoundedRectangle(cornerRadius: UIScreen.main.bounds.height*0.015)
                                    .foregroundColor(/*@START_MENU_TOKEN@*/.blue/*@END_MENU_TOKEN@*/)
                                    .frame(width: UIScreen.main.bounds.width*0.35, height: UIScreen.main.bounds.height*0.04, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
                                Text("\(formatarCotacao(valor: valor*(quoteListVM.quotes.first?.bid ?? 1), tipo: false))").foregroundColor(Color.white)
                                        .font(Font.custom("Poppins-Medium", size: UIScreen.main.bounds.height*0.018))
